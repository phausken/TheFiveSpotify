...
import { createPlaylistFollow, deletePlaylistFollow } from '../../actions/playlist_follows_actions';
...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    createPlaylistFollow: (playlistFollow) => dispatch(createPlaylistFollow(playlistFollow)),
    deletePlaylistFollow: (playlistFollow) => dispatch(deletePlaylistFollow(playlistFollow)),
  };
};

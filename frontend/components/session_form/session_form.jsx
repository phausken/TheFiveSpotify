...
class SessionForm extends React.Component {
  ...
  render() {
    ...
    const altLink =
      this.props.formType === "login" ? "Sign up here!" : "Log in here!";
    const altMessage =
      this.props.formType === "login"
    ...
    return (
      <div className="big-wrap">
        <div className="screen-login">
          {this.props.loggedIn ? <Redirect to="/main_page" /> : <div />}
          ...
          <span className="alt-message">
            {altMessage}
            <Link onClick={this.props.clearErrors} to={altPath}>
              {altLink}
            </Link>
          </span>
        </div>
